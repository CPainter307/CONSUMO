...
if (text2) {
	...
	currentTrigger.t_scene_info = [
		...
		[cutscene_create_textbox, ["Use " + leftHandString + " to hold in your left hand and " + rightHandString + " to hold in your right.","Press again to throw in the direction you're moving. Hold " + lockString +" to aim with precision."], "Old Man", voice.oldman, sOldmanPortrait],	
		//[cutscene_create_textbox, [], "Old Man", voice.oldman, sOldmanPortrait],	
